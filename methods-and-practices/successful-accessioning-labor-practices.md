...
[BEST PRACTICE 13.1 ➤ Treat accessioning positions as skilled, professional labor](successful-accessioning-labor-practices.md#bp13-1)
{% endtab %}
...
The following is an example list of the most common—and most crucial—partners. _Appendix C includes a detailed_ [_exploration of these partnerships_](../appendices/appendix-c.-partnerships-in-accessioning.md) _and Appendix D includes a_ [_template and model for identifying local partners and examining relationships_](../appendices/appendix-d.-templates/partners-in-accessioning-environmental-scan.md)_._
